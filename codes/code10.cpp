...
int main()
{
    //extendedType<int> extInt01("êÆêîA");
    namedExtendedType<int> extInt01("êÆêîA");
    extInt01.read();
    extInt01.displayDouble();
    extInt01.setInstanceName("FirstInt");
    extInt01.display();

    namedExtendedType<int> extInt02("êÆêîB");
    extInt02.read();
    extInt02.displayDouble();

    std::cout << "ägí£êÆêîAÇ∆ägí£êÆêîBÇ∆ÇÃòaÅu+Åv" << std::endl;
